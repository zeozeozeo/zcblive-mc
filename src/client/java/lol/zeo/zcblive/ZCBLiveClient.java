...
public class ZCBLiveClient implements ClientModInitializer {
	...
	private static final String CATEGORY = "key.category.zcb-live.controls";
	private static final KeyMapping TOGGLE_CLICKBOT = KeyBindingHelper.registerKeyBinding(new KeyMapping(
		"key.zcb-live.toggle_clickbot",
		InputConstants.UNKNOWN.getType(),
		InputConstants.UNKNOWN.getValue(),
		CATEGORY
	));
	private static final KeyMapping CHANGE_INPUT_MODE = KeyBindingHelper.registerKeyBinding(new KeyMapping(
